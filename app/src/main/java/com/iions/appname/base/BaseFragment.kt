package com.iions.appname.base
...
//        loadingLayout?.findViewById<TextView>(R.id.txtLoading)?.text = message?:getString(R.string.please_wait)
//        loadingLayout?.findViewById<ProgressBar>(R.id.progressBar)?.visibility = View.VISIBLE
//        binding?.root?.findViewById<RelativeLayout>(R.id.loadingLayout)?.findViewById<Button>(R.id.btnAction)?.visibility = View.GONE
    }
